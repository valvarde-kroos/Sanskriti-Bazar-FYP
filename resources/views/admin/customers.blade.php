                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <button class="btn-action view" onclick="viewCustomer({{ $customer->id }})" title="View Details">
                                    <i class="fas fa-eye"></i>
                                </button>
                                <button class="btn-action edit" onclick="editCustomer({{ $customer->id }})" title="Edit Customer">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <button class="btn-action delete" onclick="deleteCustomer({{ $customer->id }})" title="Delete Customer">
